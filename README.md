...
The HTML files in the repository are resulted by the Pandas Profiling that we applied to the data sources.

-- PHASE 2 --

The Jupyter Notebook project_phase_2.ipynb was used for building the Data Mart and within the Data Fusion process.

The ipai25.db is the SQLite3 Data Mart that was built.

We customily created a mapping between the countries and their capitals in the country_capitals.json file.
